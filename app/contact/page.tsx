            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 text-white">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">123 Adventure Street, Travelville, TB 54321</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">hello@tripbuddy.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="h-10 w-10 rounded-full bg-white/20 flex items-center justify-center hover:bg-primary transition-colors"
                  >
